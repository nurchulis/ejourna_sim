...
function sc_online_i(id, fcolor, bgcolor) {
    ...
    ga.async = "async";
    ga.src = '//www.supercounters.com/fc.php?id=' + id + '&w=1&v=2' + info; (document.getElementsByTagName("head")[0] || d.getElementsByTagName("body")[0]).appendChild(ga);
...
function sc_onlineimage(id, count) {
    ...
    c.onload = function() {
        ...
        cd.onclick = function() {
            window.open("//www.supercounters.com/stats/" + id);
        };
